...
<head>
    ...
    <script>
        window.location.href = "{{route('admin.select')}}";
    </script>
    @endif
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-3 mb-4" href="{{route('admin.index')}}">
                <div class="sidebar-brand-icon">
                    <img src="{{asset('img\saintlucia.png')}}" class="admin-logo">
                </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePages2" aria-expanded="true" aria-controls="collapsePages">
                    ...
                    <span>Accommodation<br>Report</span>
                </a>
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('admin.report')}}">Detailed View</a>
                        <a class="collapse-item" href="{{route('admin.report2')}}">Summary View</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('admin.payment')}}">Make Payment</a>
                        <a class="collapse-item" href="{{route('admin.history')}}">Payment History</a>
                        <a class="collapse-item" href="{{route('admin.invoices')}}">Invoices</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Saint Lucia Tourism Levy | Powered By <a href="https://convergesolve.com/">Converge Solutions</a></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <a class="scroll-to-top rounded none" href="#page-top">
